    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-purple-950 to-black text-white relative">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-10 w-full max-w-lg shadow-2xl relative z-10">
                ...
                <p className="text-gray-400 text-center mb-8 text-sm">Sign in to your CodePilot AI account to continue.</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <div className="flex justify-between items-end mt-3 mb-1">
                            ...
                            <Link href="/forgot-password" className="text-xs text-purple-400 hover:text-purple-300 transition-colors underline underline-offset-2">
                                Forgot Password?
                            </Link>
                        </div>
                    ...
                    <button 
                        ...
                        className={`mt-4 font-semibold text-lg p-3.5 rounded-lg transition-all flex items-center justify-center gap-2 ${
                            !isFormValid || loading
                ...
                <p className="text-sm text-gray-400 mt-8 text-center h-full">
                    ...
                    <Link href="/signup" className="text-purple-400 font-semibold hover:text-purple-300 underline decoration-purple-500/30 underline-offset-4">
                        Sign Up
                    </Link>
                </p>
